...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\linewidth]{../src/img/kmeans_adult_balance_class_distribution.png}
...
\textbf{Dry Bean:} O conjunto Dry Bean é composto por mais de 13 mil amostras de feijões secos de sete diferentes cultivares, com atributos morfológicos extraídos de imagens. Todos os atributos são numéricos, facilitando a aplicação direta das técnicas de normalização. Apesar de apresentar uma distribuição de classes mais equilibrada que o Adult, algumas cultivares são minoritárias. Por isso, também foi realizado balanceamento por oversampling para igualar o número de amostras de cada classe antes da divisão em treino e teste. Essa preparação garante que os métodos de agrupamento possam explorar de forma justa as relações entre as amostras e as classes reais.\\
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\linewidth]{../src/img/kmeans_drybean_class_distribution.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\linewidth]{../src/img/kmeans_drybean_balance_class_distribution.png}
...
\begin{itemize}
    ...
    \item \textbf{Balanceamento:} No Adult, foi realizado oversampling para igualar as classes; no Dry Bean, também foi realizado balanceamento por oversampling devido à presença de classes minoritárias.
...
% Gráficos de resultados do KMeans no Dry Bean balanceado

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{../src/img/kmeans_drybean_balance_accuracy_repetitions.png}
    \caption{Acurácia por repetição do KMeans no Dry Bean balanceado.}
    \label{fig:kmeans_drybean_acc_repeticoes}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{../src/img/kmeans_drybean_balance_mse_repetitions.png}
    \caption{Erro médio quadrático (MSE) por repetição no Dry Bean balanceado.}
    \label{fig:kmeans_drybean_mse_repeticoes}
\end{figure}

% \begin{figure}[ht]
%     \centering
%     \includegraphics[width=0.9\linewidth]{../src/img/kmeans_drybean_balance_confusion_matrix_media.png}
%     \caption{Matriz de confusão média das execuções no Dry Bean balanceado.}
